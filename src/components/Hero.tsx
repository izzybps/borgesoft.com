        ...
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-8 animate-fade-in">
            ...
            <span className="font-mono text-sm text-muted-foreground">
              Software Solutions from Brazil
            </span>
          </div>

          {/* Main Heading */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-mono font-bold leading-tight mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            We build{" "}
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-8 border-t border-border animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {[
